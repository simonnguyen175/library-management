...
Quản lý **trực quan** những quyển sách trong Thư viện

+ Hỗ trợ tìm kiếm theo Tên sách, Tác giả, Thể loại.
+ Hỗ trợ **Thêm sách** đơn giản dễ thao tác. Có thể autofill thông tin dựa trên **ISBN**.
+ Hiện **Thông tin** sách bao gồm cả Review sách, Số trang, Nhà xuất bản, ...
